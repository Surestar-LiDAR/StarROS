...
#ifndef __STAR_SDK_MSG_ISF_V4_1_PACKET_H
#define __STAR_SDK_MSG_ISF_V4_1_PACKET_H
...
typedef struct {
    ...
    uint16_t    calculate_encode : 10;
    uint16_t    mirror_id: 2;
    uint16_t    package_format : 2;
#endif
    uint16_t    flags;
...
#endif //__STAR_SDK_MSG_ISF_V4__PACKET_H
