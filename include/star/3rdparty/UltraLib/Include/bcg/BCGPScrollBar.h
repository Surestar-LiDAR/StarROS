...
protected:
								   ...
								   BOOL bHighlighted, BOOL bPressed, BOOL bDisabled)
	{
		if (m_Style == BCGP_SBSTYLE_OWNER_DRAW)
		{
			BCGPSCROLLBAR_DRAW_INFO info (
				pDC, this, BCGP_SCROLLBAR_THUMB, rect, bHorz, bHighlighted, bPressed, FALSE, bDisabled);
								...
								BOOL bHighlighted, BOOL bPressed, BOOL bFirst, BOOL bDisabled)
	{
		...
		{
			BCGPSCROLLBAR_DRAW_INFO info (
				pDC, this, BCGP_SCROLLBAR_BUTTON, rect, bHorz, bHighlighted, bPressed, bFirst, bDisabled);
									...
									BOOL bHighlighted, BOOL bPressed, BOOL bFirst, BOOL bDisabled)
	{
		...
		{
			BCGPSCROLLBAR_DRAW_INFO info (
				pDC, this, BCGP_SCROLLBAR_BACKGROUND, rect, bHorz, bHighlighted, bPressed, bFirst, bDisabled);
